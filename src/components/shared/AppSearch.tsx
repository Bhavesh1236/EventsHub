...
const AppSearch = () => {
  return (
    <View style={{width:'100%', height:50, flexDirection: 'row', justifyContent:'flex-start', alignItems:'center',paddingHorizontal:20}}>
      ...
      <TextInput placeholder='Search...' placeholderTextColor={"#999"} style={{marginHorizontal:10,fontSize:20 ,color:colors.lightBlue,width:'65%',borderLeftWidth:1, paddingLeft:5}} />
      <TouchableOpacity style={{flexDirection:'row',backgroundColor:colors.appBule4,borderRadius:50,padding:sizes.base,alignItems:'center'}}>
